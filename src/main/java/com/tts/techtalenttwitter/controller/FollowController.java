...
public class FollowController {
	...
	//All our follow controller is going to do currently it process requests
	//for follows and t request a follow...all user has to do is visit
	//"/follow/{username}" with a post request
